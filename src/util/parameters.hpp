...
struct CutHeuristicParameters
{
    ...
    CutHeuristicParameters &withNumIntervals(unsigned v)
    {
        cuthNumIntervals = v;
        return *this;
    }

    CutHeuristicParameters &withMaxTrials(unsigned v)
    {
        cuthMaxTrials = v;
        return *this;
    }
...
{
    string mipModel;
    bool mipPreprocessing, mipSolveRelaxation, mipSaveModel, mipBranchingPriorities, mipDisablePresolve, mipComputePresolve, mipMINBPFORBID;
